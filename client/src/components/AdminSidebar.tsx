...
export default function AdminSidebar() {
    ...
    const items: NavItem[] = [
        ...
        { id: "pending-experts", label: "Expert Verification", to: "/admin/experts/pending", icon: <Users size={20} /> },
        { id: "rejected-experts", label: "Rejected Experts", to: "/admin/experts/rejected", icon: <FileX size={20} /> },
        { id: "users", label: "Users", to: "/admin/users", icon: <Users size={20} /> },
        { id: "categories", label: "Categories", to: "/admin/categories", icon: <Layers size={20} /> },
        { id: "reports", label: "Reports", to: "/admin/reports", icon: <Flag size={20} /> },
    ];
